"""
81 ilin tamamı — harita SVG g[data-iladi] değerleriyle birebir eşleşmeli.
İstanbul, haritada Avrupa/Asya olarak ikiye ayrıldığı için iki kayıt içerir.
"""
...
PROVINCE_NAMES = [code for code, _ in PROVINCE_CHOICES]
